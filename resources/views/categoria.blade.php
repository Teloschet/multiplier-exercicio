      ...
      <div class="container" style="display:flex;justify-content:center;text-align:center;">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
              <a href="{{ url('categoria') }}" class="nav-link text-secondary">
...
<h1 class="text-left mt-4 col-8 mb-4 m-auto">Cadastrar Categorias</h1>
    ...
    <form action="{{ url('/categoria') }}" name="formCad" id="formCad" method="post">
        @csrf
        <div class="table-responsive">
            <table class="table table-striped text-center">
                ...
                <tbody>
                    <tr>
                        <td>
                        <input type="text" name="name" class="form-control" style="text-align:center;" required placeholder="Nome da Categoria">
                        </td>
                    </tr>
                </tbody>
                <tfoot class="tfoot-dark bg-dark">
                    <tr>
                        <td style="display:flex;margin-left:0px;"><input type="submit" value="Adicionar Categoria" class="btn btn-success"></td>
                    </tr>
                </tfoot>
                </table>
    </form>
        ...
        <div class="col-8 m-auto mt-4">
            @csrf
            <h2><i class="fas fa-columns"></i>  Categorias</h2>
            <div class="table-responsive">
